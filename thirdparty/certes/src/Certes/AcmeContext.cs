...
namespace Certes
{
    ...
    public class AcmeContext : IAcmeContext
    {
        ...
        public async Task<Account> ChangeKey(IKey? key)
        {
            ...
            var resp = await HttpClient.Post(this, endpoint, body, true, AcmeJsonContext.Default.JwsPayload, AcmeJsonContext.Default.Account);
        ...
        public async Task RevokeCertificate(byte[] certificate, RevocationReason reason, IKey? certificatePrivateKey)
        {
            ...
            {
                await HttpClient.Post(this, endpoint, body, true, AcmeJsonContext.Default.CertificateRevocation, AcmeJsonContext.Default.String);
            }
        }
        ...
        public async Task<IOrderContext> NewOrder(IList<string> identifiers, DateTimeOffset? notBefore = null, DateTimeOffset? notAfter = null)
        {
            ...
            var order = await HttpClient.Post(this, endpoint, body, true, AcmeJsonContext.Default.Order, AcmeJsonContext.Default.Order);

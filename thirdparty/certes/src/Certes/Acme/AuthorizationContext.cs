...
namespace Certes.Acme
{
    ...
    internal class AuthorizationContext : EntityContext<Authorization>, IAuthorizationContext
    {
        ...
        {
            var authz = await Resource(AcmeJsonContext.Default.Authorization);
            return authz
                .Challenges?
        ...
        public async Task<Authorization> Deactivate()
        {
            ...
            var resp = await Context.HttpClient.Post(Context, Location!, payload, true, AcmeJsonContext.Default.Authorization, AcmeJsonContext.Default.Authorization);

...
internal class AcmeClient
{
    ...
    public AcmeClient(ILogger<AcmeClient> logger, IOptionsMonitor<LettuceEncryptOptions> options, Uri directoryUri, IKey acmeAccountKey)
    {
        _logger = logger;
        _options = options;
    ...
    public async Task<int> CreateAccountAsync(string emailAddress)
    {
        ...
        var eabCredentials = _options.CurrentValue.EabCredentials;

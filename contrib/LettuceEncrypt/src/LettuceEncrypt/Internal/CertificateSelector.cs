...
internal class CertificateSelector : IServerCertificateSelector
{
    ...
    public CertificateSelector(IOptionsMonitor<LettuceEncryptOptions> options, ILogger<CertificateSelector> logger)
    {
    ...
    public X509Certificate2? Select(ConnectionContext context, string? domainName)
    {
        ...
        {
            return _options.CurrentValue.FallbackCertificate;
        }
